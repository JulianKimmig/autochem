...
EXPECTED_PEAKS = [2.8, 3.9, 4.12, 4.3, 4.5]  # list of expected peaks for shift correction
...
MANUAL_PEAK_NAMES = ["OME-CH3","OME-1","OME-2","OME-3+","Trioxane"]

# REFERENCE_PEAK=None
REFERENCE_PEAK = 2.8  # reference peak used as integration standart
...
def work_spec(data, data_dict, path):
    ...
    if REFERENCE_PEAK is not None:
        ...
        try:
            ...
            in_ppm = (ppm_scale >= REFERENCE_PEAK - REFERENCE_PEAK_WINDOW) & (
                        ppm_scale <= REFERENCE_PEAK + REFERENCE_PEAK_WINDOW)
            ...
            peaks, peak_data, _ppm = merge_peaks_data(peaks, sub_peaks, peaks_data1=peak_data,
                                                      peaks_data2=sub_peak_data, x1=ppm_scale,
